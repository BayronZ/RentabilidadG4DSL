...
# Crear el programa emprendedor1.rb donde el usuario ingrese el precio, el número de usuarios, los gastos y el programa calcula las utilidades.
...
#Aplicar impuestos si el resutlado esmpositivo
